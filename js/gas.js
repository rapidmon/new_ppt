const $bend_account_img_wrapper = document.querySelector(".bend-account-img-wrapper");
const $bend_account_img = document.querySelector(".bend-account-img");
const $chart_wrapper = document.querySelector(".chart-wrapper");
const $account_img = document.querySelector(".account-img");
const $meter_img_wrapper = document.querySelector(".meter-img-wrapper");
...
$bend_account_img_wrapper.addEventListener("click", function(){
    if(!$bend_account_img_wrapper.classList.contains("for-disappear")){
        $bend_account_img.style.border = "none";
        $bend_account_img_wrapper.classList.add("for-disappear")
        $chart_wrapper.style.zIndex = "40";
        setTimeout(function(){
            $bend_account_img.style.opacity = "0";
            $account_img.style.opacity = "1";
            setTimeout(function(){
...
const $snow_part = $article_part[2].childNodes[9]
$snow_part.style.opacity = 0;
$snow_part.style.display = "block";
$snow_part.style.position = "absolute";
$snow_part.style.top = 0;
$snow_part.style.zIndex = "40";
$snow_part.style.transition = "1s";
$snow_part.style.height ="600px";
$snow_part.style.width ="1200px";

$snow_part.addEventListener("click", function(){
    if($article_part[2].classList.contains("article-part-open")){
        $snow_part.style.opacity = 1;
        $number_wrapper[0].style.top = `-${window.getComputedStyle($number_wrapper[0]).getPropertyValue('height').split("px")[0]*5/6}px`
        $number_wrapper[1].style.top = `-${window.getComputedStyle($number_wrapper[1]).getPropertyValue('height').split("px")[0]*4/5}px`
